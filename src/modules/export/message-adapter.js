...
const INCOMPLETE_EXPORT_NOTICE_PREFIX = "ChatVault AI notice:";
...
function defaultPlatformLabel(platform) {
  ...
  export function createExportMessageAdapter(options) {
    ...
    function getCrossPlatformExportMessage(platform) {
      ...
      return "Open " + label + " (" + host + ") and use ChatVault AI there to export this conversation body. " + (currentLabel || "This page") + " cannot read " + label + " message content.";
    }
    ...
    function getIncompleteConversationMessage(chat) {
      ...
      return INCOMPLETE_EXPORT_NOTICE_PREFIX + " This export may be incomplete. " + label + " returned AI replies for " + titleLabel + " without the original user questions, so ChatVault exported the available replies and marked this file. To recover the missing questions, open this conversation in " + label + " and export again, or use Select messages export after the conversation is open.";
    }
