export function makeStoreCopy(locale, platform) {
  ...
  const syncOverrides = {
    en: {
      slide1: { label: "Batch Export & Sync", title: ["Batch Export &", "1-Click Sync", "to Notion / Obsidian"], body: [`Save multiple ${p} chats in bulk.`, "Sync your knowledge base in one click."], bullets: ["Multiple chats at once", "Notion / Obsidian sync", "PDF, Word, Markdown, JSON"] },
